...
if($act == 'QQlogin')
{
$url="https://graph.qq.com/oauth2.0/authorize?response_type=token&client_id={$_CFG['qq_appid']}&redirect_uri={$_CFG['main_domain']}wap/connect_qq_client.php".urlencode('?act=login_check');
header("Location:{$url}");	
}
